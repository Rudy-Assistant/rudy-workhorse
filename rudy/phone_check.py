...
# MVTIntegration extracted to rudy/integrations/mvt_integration.py (ADR-005 Phase 2a)
from rudy.integrations.mvt_integration import MVTIntegration  # noqa: F401 backward compat
...
# ForensicPhoneCheck extracted to rudy/forensics/phone_forensics.py (ADR-005 Phase 2a)
from rudy.forensics.phone_forensics import ForensicPhoneCheck  # noqa: F401 backward compat
