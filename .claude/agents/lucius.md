...
2. Time allocation: 65% implementation, 20% diagnosis, 15% records.
3. Session records max 30 lines. Handoffs max 40 lines.
4. Before building custom: search MCP registry, check pip list, review capability index.
