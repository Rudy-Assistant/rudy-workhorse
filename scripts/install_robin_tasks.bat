...
schtasks /create /tn "Batcave\Robin Watchdog" /tr "C:\Users\ccimi\Desktop\rudy-workhorse\scripts\robin_watchdog.bat" /sc MINUTE /mo 15 /f
if %errorlevel% == 0 (
...
schtasks /create /tn "Batcave\Robin Continuous" /tr "C:\Users\ccimi\Desktop\rudy-workhorse\scripts\robin_continuous.bat" /sc ONLOGON /f
if %errorlevel% == 0 (
