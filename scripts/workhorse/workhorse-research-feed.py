...
class ReportGenerator:
    ...
    def save_markdown_report(self, items: List[ResearchItem], timestamp: str = None) -> Path:
        ...
        lines.append("**Period:** Last 24 hours\n\n")
        ...
        lines.append("---\n")
        lines.append("*This digest was auto-generated by workhorse-research-feed.py*\n")
...
class ResearchFeedSystem:
    ...
    def run(self) -> tuple[List[ResearchItem], Path, Path]:
        ...
        if self.quick_mode:
            ...
            self.logger.info("QUICK mode: Limiting to top 5 items")
